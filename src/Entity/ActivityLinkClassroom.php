...
class ActivityLinkClassroom implements \JsonSerializable, \Utils\JsonDeserializer
{
    ...
    public function setIntroduction($introduction)
    {
        if (is_string($introduction) && strlen($introduction) < 2000) {
            ...
            throw new EntityDataIntegrityException("introduction needs to be string with a length lesser than 2000 and" . strlen($introduction));
        }
    }
    ...
    public function setCommentary($commentary)
    {
        if (is_string($commentary) && strlen($commentary) < 2000) {
            ...
            throw new EntityDataIntegrityException("commentary needs to be string with a length lesser than 2000");
        }
    }
    ...
    public function setReference($reference)
    {
        if (is_string($reference) && strlen($reference) < 13) {
            ...
            throw new EntityDataIntegrityException("reference needs to be string with a length lesser than 13");
        }
    }
